...
.lp-bg{position:absolute;inset:0;background-image:url('/bg.jpg');background-size:cover;background-position:center;opacity:.28;filter:saturate(1.2) hue-rotate(160deg)}
.lp-bg-fallback{position:absolute;inset:0;background:radial-gradient(ellipse at 20% 50%, rgba(0,94,122,.5) 0%, transparent 60%),radial-gradient(ellipse at 80% 20%, rgba(0,60,80,.55) 0%, transparent 55%),linear-gradient(135deg,#001c2f 0%,#002d45 40%,#001a2c 100%)}
